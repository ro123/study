...
class Ip_address():
    ...
    def __init__(self, dec_ip, bin_ip, pre_mask, dec_mask, bin_mask):
        self.dec_ip = dec_ip #айпи в точечном виде
        self.bin_ip = bin_ip #ip in binary
        self.dec_mask = dec_mask  #mask in decimal
        self.pre_mask = pre_mask  # mask in prefix
        self.bin_mask = bin_mask  # mask in binary
    ...
    #to work. have to add all ip and split cells by :
